...
void test_run2(std::vector<Triangle> triangles, Transformations transformations, double learning_rate, int iterations){
...
int main()
{
  ...
  test_run2(triangles, transformations1, 0.0001, 10000);
